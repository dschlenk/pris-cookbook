...
describe pris_requisition('fooscript') do
  ...
  its('source_properties') { should eq 'file' => 'myGroovySource.groovy', 'count' => '5' }
...
<model-import xmlns="http://xmlns.opennms.org/xsd/config/model-import" foreign-source="fooscript">
    ...
    <node node-label="MyNodeLabel3" foreign-id="MyForeignId3">
        <interface ip-addr="127.0.0.3" status="1" snmp-primary="P">
            <monitored-service service-name="ICMP"/>
            <monitored-service service-name="SNMP"/>
            <monitored-service service-name="HTTP"/>
        </interface>
    ...
    <node node-label="MyNodeLabel4" foreign-id="MyForeignId4">
        <interface ip-addr="127.0.0.4" status="1" snmp-primary="P">
            <monitored-service service-name="ICMP"/>
            <monitored-service service-name="SNMP"/>
            <monitored-service service-name="HTTP"/>
        </interface>
